# Generated by Django 3.0.8 on 2020-07-20 09:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('MC', 'Mens Clothing'), ('WC', 'Womens Clothing'), ('G', 'Games'), ('T', 'Tech'), ('BP', 'Beauty Products'), ('O', 'Others')], max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('items', models.ManyToManyField(to='auctions.Bid')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
